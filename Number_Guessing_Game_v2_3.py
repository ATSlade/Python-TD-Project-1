...
#EXIT/QUIT
        if player_guess.lower() == 'x':
            ...
            try:
                ...
                continue
            guess_count += 1    
# CHECK if guess is correct and perform actions (suggest on clarity provided by TD Mentor, Jennifer)
...
# PLAY AGAIN or QUIT
                    ...
                    if play_again.lower() == 'y':
                        ...
                        break                
# CHECK if guess is in range and also is an integer (suggest on clarity provided by TD Mentor, Jennifer)
