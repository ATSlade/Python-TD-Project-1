...
player_name = input('Hello. With whom do I have the pleasure? (Enter your first name): ')
...
while correct == False:
    ...
    # If guess is less, display "It's higher"
      ...
      # If guess = rando, display "Got it"
        ...
        correct = True
print("\nThe Number Guessing game is over. Thanks for playing, {}!\n".format(player_name))        
    ...
    # Warn the e player about a repeated guess
